                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-md-6 ">
                         <li><a href="https://maps.app.goo.gl/dPDgVNk7VDsktkd4A" style="color:white"><i class="fa fa-podcast"> Kantor Desa FairyTail Cek Lokasi disini</i></a></li>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> Desa FairyTail</a></li>
                                    <li><a href="#"> <i class="fa fa-phone"></i>0822-2937-7661</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-6 col-lg-7">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                            <i class="fa fa-home" style="color:pink"><li><a class="active" href="index.php">Home</a></li></i>&nbsp;
                            <i class="fa fa-sign-in" style="color:pink"><li><a class="popup-with-form" href="#test-form">Login Admin/Petugas</a></li></i>
                            			</ul>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text">
                                ...
                                <p>Selamat datang di web Pengaduan Masyarakat Desa FairyTail<br>
