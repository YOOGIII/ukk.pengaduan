                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="masarakat_admin.php">
                                        <img style="width:100px;"src="img/FairyTail desa.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-7">
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul>
                                        <i class="fa fa-home" style="color:pink"><li><a class="active" href="masarakat_admin.php">Home</a></li></i>
                                        <i class="fa fa-bar-chart" style="color:pink"><li><a class="active" href="pengaduan1.php">Pengaduan Saya</a></li></i>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                ...
                                <p>Selamat datang di web Pengaduan Masyarakat Desa FairyTail <br>
                                    Silahkan adukan Keluh Kesah anda terhadap pemerintahan desa FairyTail</p>
