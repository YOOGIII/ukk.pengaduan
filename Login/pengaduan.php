                            ...
                            <div class="col-xl-3 col-lg-2">
                                <div class="logo">
                                    <a href="masarakat_admin.php">
                                        <img style="width:100px;"src="img/konoha.png" alt="">
                                    </a>
                                </div>
                            </div>
        ...
        <div class="slider_active owl-carousel">
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay2">
             ...
             <div class="slider_text ">
                                ...
                                <p style="color:white">Selamat datang di web Pengaduan Masyarakat Desa konoha<br>
                                    Silahkan adukan Keluh Kesah anda terhadap pemerintahan Desa Konoha</p>
